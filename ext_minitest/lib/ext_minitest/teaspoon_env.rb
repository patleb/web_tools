Teaspoon.configure do |config|
  config.asset_manifest += [/(?:\/|\\|\A)spec_helper\.js$/]
  ...
  config.suite do |suite|
    ...
    #suite.matcher = "{test/javascripts,app/assets}/**/*_test.coffee"

    # Load additional JS files, but requiring them in your spec helper is the preferred way to do this.
    suite.javascripts = ["vendor", "application", "ext_minitest/spec_helper"]
  ...
  # teaspoon --driver=phantomjs --server-port=31337 --fail-fast=true --format=junit --suite=my_suite /test/file_test.js
  #
  # Rake:
