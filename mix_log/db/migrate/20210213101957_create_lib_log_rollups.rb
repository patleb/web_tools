class CreateLibLogRollups < ActiveRecord::Migration[6.0]
  def change
    ...
    add_index :lib_log_rollups, [:type, :group_name, :group_value, :period, :period_at], unique: true,
      name: 'index_lib_log_rollups_on_groups'
    add_index :lib_log_rollups, [:type, :group_name, :group_value, :period, :period_at, :json_data], using: :gin,
