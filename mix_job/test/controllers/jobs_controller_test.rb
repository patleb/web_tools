...
class JobsControllerTest < ActionDispatch::IntegrationTest
  ...
  describe '#perform' do
    ...
    it 'should handle exceptions' do
      ...
      assert_equal true, LogLabel.where('text_tiny LIKE ?', '%ActionController::ParameterMissing%').take.alerted?
    ...
    it 'should handle bad params' do
      ...
      assert_equal true, LogLabel.where('text_tiny LIKE ?', '%ActiveRecord::RecordInvalid%').take.alerted?
      assert_equal 1, ActionMailer::Base.deliveries.size
    end
  end
end
