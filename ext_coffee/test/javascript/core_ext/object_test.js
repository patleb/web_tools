...
describe('Object', () => {
  ...
  test('#tap', () => {
    ...
    assert.equal('value', 'value'.tap(string => value = string.toString() ).toString())
  ...
  test('#map_each', () => {
    assert.equal([1, 2], { a: 1, b: 2 }.map_each((k, v) => v))
  })
  ...
  test('#select_each', () => {
    assert.equal({ b: 2 }, { a: 1, b: 2, c: 3 }.select_each((k, v) => v === 2))
  })
