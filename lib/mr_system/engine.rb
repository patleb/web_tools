require 'mr_system/rails/env'

module ActionService
  autoload :Base, 'mr_system/action_service/base'
end
...
module MrSystem
  class Engine < ::Rails::Engine
    ...
    require 'vmstat'
    require 'mr_system/action_mailer/smtp_settings'
    require 'mr_system/active_support/core_ext'
    require 'mr_system/active_support/current_attributes'
    require 'mr_system/active_support/dependencies/with_nilable_cache'
    require 'mr_system/money_rails'
    ...
    config.before_initialize do |app|
      require 'mr_system/action_dispatch/middleware/iframe'
    ...
    initializer 'mr_system.append_migrations' do |app|
      append_migrations(app)
      append_api_migrations(app) if Setting[:pgrest_enabled]
    end

    initializer 'mr_system.append_routes' do |app|
    ...
    initializer 'mr_system.default_url_options', before: 'action_mailer.set_configs' do |app|
    ...
    initializer 'mr_system.i18n' do
      if defined? I18n::Debug
        unless MrSystem.config.i18n_debug
    ...
    initializer 'mr_system.rack_lineprof' do |app|
      if (file = Rails.root.join('tmp/profile.txt')).exist? && (matcher = file.readlines.first&.strip).present?
        require 'mr_system/rack_lineprof'
        app.middleware.use Rack::Lineprof, profile: matcher
      end
    end

    ActiveSupport.on_load(:action_controller, run_once: true) do
      require 'mr_system/action_dispatch/routing/url_for/with_only_path'
      require 'mr_system/action_controller/parameters'
      require 'mr_system/action_controller/with_status'
      require 'mr_system/action_controller/with_errors'
      require 'mr_system/action_controller/with_logger'
    end
    ...
    ActiveSupport.on_load(:action_controller_api) do
      require 'mr_system/action_controller/api'
    end

    ActiveSupport.on_load(:action_controller_base) do
      require 'mr_system/action_controller/base'
    end

    ActiveSupport.on_load(:active_record) do
      require 'rails_select_on_includes'
      require 'mr_system/active_type'
      require 'mr_system/active_record/connection_adapters/postgresql_adapter'
      require 'mr_system/active_record/base'
      require 'mr_system/active_record/relation'
      require 'mr_system/active_record/tasks/database_tasks/with_single_env'
    end

    ActiveSupport.on_load(:action_mailer) do
      require 'mr_system/action_mailer/base'
      require 'mr_system/action_mailer/log_subscriber/with_quiet_info'
    end
  end
end
